...
def allergy_page() -> Optional[Embed]:
    embed = Embed(
        title="급식 알레르기 정보",
        description=f"급식에 표시된 숫자 각각이 의미하는 알레르기 정보 입니다.",
        color=5681003,
    )
    embed.set_author(name="🔍 알레르기 정보")

    embed.add_field(
        name=f"알레르기 정보",
        value=(
            f"1.난류, 2.우유, 3.메밀, 4.땅콩, 5.대두, 6.밀, 7.고등어, 8.게, 9.새우, 10.돼지고기, 11.복숭아,"
            f" 12.토마토, 13.아황산염, 14.호두, 15.닭고기, 16.쇠고기, 17.오징어, 18.조개류(굴,전복,홍합 등)"
        ),
        inline=True,
    )
