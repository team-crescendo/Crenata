...
from crenata.infrastructure.utils.datetime import to_weekday
...
font_path = "./crenata/application/assets/fonts"
...
async def make_timetable_image(
    results: list[list[Timetable]], date: datetime
) -> BytesIO:
    """
    시간표를 이미지로 변환합니다.
    """
    ...
    for result in results:
        ...
        day = ""
        for r in result:
            timetable.append(r.subject)
            day = to_weekday(r.date)
